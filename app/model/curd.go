...
*/
func (ml *MemberUsers) PublicPage(uid int, partnerId int, domain, search, searchfields, fields string, offset int, limit int, order string, table string) []map[string]interface{} {
